...
const projectManagement = () => {
  ...
  return (
    <div >
<Head>
    <title>Project Management Services | Expert Project Management Consultants</title>
    <meta
      name="description"
  ...
  <div className="w-full md:w-[50vw] text-center md:text-left mb-6 md:mb-0 md:mt-10  md:px-12   mt-20">
    <h1 className="text-3xl lg:text-5xl font-bold">Efficient Project Management Services</h1>
...
<div className='max-w-7xl  mx-auto'>
  ...
  <div className="relative lg:static lg:flex-shrink-0 lg:w-[300px]  lg:h-[450px] z-10">
    <Image
      src={projectimage1}
      alt="Trust Us to handle your Project Management"
      width={300} 
      height={450}
  ...
  <div className="bg-[#9A00FF] w-full md:w-[800px]   lg:h-[450px] p-6 sm:p-10 lg:p-16 py-10 lg:py-14 mt-8 lg:mt-0 ">
    <div className="text-white xl:py-20 lg:px-40">
      <h1 className="text-2xl sm:text-3xl font-bold mb-3">Partner with Expert Consultants</h1>
      <p className="text-sm sm:text-base lg:text-lg leading-relaxed  md:w-[500px] w-full  text-wrap">As trusted project management consultants, we bring a wealth of experience to guide your projects from initiation to completion. Whether it's resource allocation, risk assessment, or task prioritization, our consultants deliver strategies that drive measurable success. </p>
    </div>
  </div>
</div>
      </div>
...
<div className="flex flex-col md:flex-row justify-around items-center px-4 md:px-8 gap-8 md:gap-12">
  ...
  <div className="w-full md:w-[40vw] text-center md:text-left">
    <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-7">Custom Solutions for Every Challenge</h1>
  ...
  {/* Text Section */}
  <div className="w-full md:w-[40vw] text-center md:text-left">
    <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-7">Streamline Operations with Agile Project Management</h1>
    <p className="text-base md:text-xl text-gray-700">
...
<div className="flex flex-col md:flex-row justify-around mt-20 items-center px-4 md:px-8 gap-8 md:gap-12">
  ...
  {/* Text Section */}
  <div className="w-full md:w-[40vw] text-center md:text-left">
    <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-7">Efficiency with End-to-End Project Oversight</h1>
    <p className="text-base md:text-xl text-gray-700">
...
<div className="md:relative bg-[#9A00FF] md:max-w-6xl mx-auto md:py-16  md:mt-52 md:mb-52">
  <div className="md:relative px-5 flex flex-col md:flex-row items-center md:items-start gap-10">
    ...
    <div className="relative z-10 md:max-w-[600px] text-wrap text-center md:text-left">
      <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Driving Results Through Expertise</h1>
      <p className="text-base md:text-lg text-white webDevtext ">
      In a recent collaboration with a tech startup, our project management services helped streamline their product launch, reducing time-to-market by 30%. We also provided guidance to a growing enterprise, improving task coordination and achieving significant cost savings.
      </p>
    </div>
    {/* Image */}
...
<ProjectManagementRelatedProjects/>
