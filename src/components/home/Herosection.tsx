...
const Herosection = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br bg-white min-h-screen flex flex-col items-center justify-center px-6 md:px-10 overflow-hidden text-center">
        {/* Animated Background */}
