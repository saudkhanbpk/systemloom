...
const GetQoute = () => {
  return (
    <div className=" md:mt-16 mt-9 mb-9 md:mb-16 border rounded-full bg-gray-100 flex flex-col md:flex-row items-center justify-between p-6 space-y-4 md:space-y-0">
