...
const ServicesSection: React.FC = () => {
  ...
  const servicesArr: Service[] = [
    ...
    },
    {
      id: 3,
      title: "DevOps",
      des: "We bridge the gap between development and operations, ensuring seamless collaboration, automation, and faster time-to-market. From CI/CD pipelines to real-time monitoring, our tailored solutions enhance efficiency, scalability, and reliability."
      .split(" ")
      .slice(0, 20)
      .join(" ")+ "...",
    ...
    },
    {
      ...
      des: "Ensure your software runs smoothly with expert maintenance services that address issues proactively. Our team offers regular updates, efficient bug fixes, and seamless integration to ensure your applications remain optimized and secure for modern business needs."
        .split(" ")
        .slice(0, 24)
        .join(" ")+"...",
