...
const HeroSection: React.FC = () => {
  return (
    <div className="relative bg-black text-white h-auto md:py-20 overflow-hidden">
      <div className="relative max-w-[1440px] mx-auto mt-32 md:mt-0 md:py-32">
        <h1 className="text-3xl md:text-5xl md:px-10 px-2 font-bold mb-6">Our Portfolio</h1>
        <div className="flex flex-col md:flex-row  items-center">
          ...
          <div className="md:w-2/3 relative flex  justify-center md:justify-end">
            <div className="relative md:absolute md:-top-56 md:right-0 w-full  md:w-[480px]">
