    ...
    <div className="relative bg-black text-white py-16 md:py-24">
      <div className="relative  flex flex-col md:flex-row items-center px-2 md:px-12">
        ...
        <div className="md:w-1/2 text-center md:text-left md:mt-0 mt-12">
          ...
          Our <span className="text-[#0891b2]">Portfolio</span>
          </h1>
          <p className=" mt-2 md:mt-6 text-lg md:text-xl text-gray-300">
          System Loom delivers impactful solutions customized to each client's needs. Our portfolio shows how we have helped businesses achieve their goals through innovative designs, seamless development, and strategic marketing. From Marketing to Development, we help you grow your business in every aspect.
          </p>
        </div>
