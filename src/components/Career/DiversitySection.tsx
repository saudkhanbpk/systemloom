    ...
    <div>
      <div className=" mt-9 md:mt-16 mb-9 md:mb-16">
        <div className="max-w-3xl mb-6">
          <h2 className="font-semibold  font-inter mb-4 text-3xl md:text-5xl text-[#0891b2]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
         ...
         <div className="bg-[#0891b2] rounded-2xl cursor-pointer p-8 flex flex-col items-center justify-center text-white col-span-1 sm:col-span-2 md:col-span-1">
