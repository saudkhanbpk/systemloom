...
const SeoContentWritingRelatedProjects = () => {
  // Access projects from Redux store
  const { projects } = useSelector((state: RootState) => state.projects);

  // Filter projects by category 'web-development'
  const filteredProjects = projects
    .filter((project) => project.category.includes("seo-content-writing"))
    .slice(0, 6);
        ...
        <div className="py-16 px-4 ml-2 sm:ml-0">
          <div className="md:w-[92%] mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              In our recent SEO and content writing endeavors, we concentrate on crafting compelling optimized material that boosts organic traffic while enhancing brand recognition. Through well-researched blogs or captivating website text, our strategies aim to elevate search rankings connection with targeted audiences effectively.
              </p>
            </div>
...
export default SeoContentWritingRelatedProjects;
