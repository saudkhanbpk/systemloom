...
const QaTestingRelatedProjects = () => {
  ...
  const filteredProjects = projects
    .filter((project) => project.category.includes("qa-testing"))
    .slice(0, 6);
        ...
        <div className="py-16 px-4 ml-2 sm:ml-0">
          <div className="md:w-[92%] mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              Most recent works undertaken in QA testing focus on software stability, performance, and user satisfaction. Our rigorous process of testing captures and corrects issues-giving in this way optimal functioning and high-quality solutions with no errors. 
              </p>
            </div>
