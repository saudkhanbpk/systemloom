...
const OurTeam = async () => {
  ...
  return (
    <section className="flex lg:flex-row flex-col justify-between gap-6 bg-gray-100 md:py-12 py-6 rounded-lg px-6 md:mt-16 mt-9">
    ...
    <Image 
      ...
      className="rounded-lg object-contain flex justify-center lg:w-1/2"
    />
