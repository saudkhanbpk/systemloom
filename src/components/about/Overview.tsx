    ...
    <div className="py-10 px-4 md:px-10">
          <div className="flex flex-col md:flex-row w-full justify-between items-start md:items-center gap-10">
            ...
            <div className="flex w-full about-page justify-center md:justify-start gap-4 mb-6 md:mb-0">
              <div>
                <Image src={about1} alt="about" className="w-[100px] md:w-[216px] h-auto" />
              </div>
              <div>
                <Image src={about2} alt="about" className="w-[100px] md:w-[216px] mt-20 h-auto" />
              </div>
              <div>
                <Image src={about3} alt="about" className="w-[100px] md:w-[216px] h-auto" />
              </div>
            </div>
